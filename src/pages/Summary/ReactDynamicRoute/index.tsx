...
const ReactDynamicRoute = () => {
  const items = [{ children: '动态路由场景' }, { children: '动态路由具体实例' }]
  return (
    <Row>
      <Col span={6}>
        ...
        <Typography>
          <Row>
            <Col span={24}>
              ...
              <Paragraph>
                react
                router动态路由常用于用户登录后，获取用户路由表数据，映射成组件，返回新的路由表
              </Paragraph>
            </Col>
            <Col span={24}>
              ...
              <Title level={5}>
                2.先添加部分允许访问的路由表页面，例如登录，首页，404等模块
              </Title>
              <Text mark>router/index.tsx</Text>
              <CodeHighLight codeString={codeString2} />
              <Title level={5}>
                3.App.tsx页面通过<Text code>createContext</Text>实现值传递
              </Title>
